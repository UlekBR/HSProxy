...
if [[ $arch == "x86_64" || $arch == "amd64" || $arch == "x86_64h" ]]; then
    ...
    curl -o "/opt/hsproxy/proxy" -f "https://github.com/UlekBR/HSProxy/blob/main/HSProxy_x64"
    curl -o "/opt/hsproxy/sslproxy" -f "https://github.com/UlekBR/HSProxy/blob/main/HSProxySSL_x64"
    curl -o "/opt/hsproxy/menu" -f "https://github.com/UlekBR/HSProxy/blob/main/menu_x64"
elif [[ $arch == "aarch64" || $arch == "arm64" || $arch == "armv8-a" ]]; then
    echo "Sistema baseado em arm64 (64-bit ARM)"
    curl -o "/opt/hsproxy/proxy" -f "https://github.com/UlekBR/HSProxy/blob/main/HSProxy_arm64"
    curl -o "/opt/hsproxy/sslproxy" -f "https://github.com/UlekBR/HSProxy/blob/main/HSProxySSL_arm64"
    curl -o "/opt/hsproxy/menu" -f "https://github.com/UlekBR/HSProxy/blob/main/menu_arm64"
else
